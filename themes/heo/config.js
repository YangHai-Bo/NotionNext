const CONFIG = {
  ...
  HEO_SITE_CREATE_TIME: '2023-10-1', // 建站日期，用于计算网站运行的第几天

  // 首页顶部通知条滚动内容，如不需要可以留空 []
  HEO_NOTICE_BAR: [
    { title: '欢迎来到林玲柒的小破站', url: 'https://www.qige.store/' },
    { title: '访问文档中心获取AI工具', url: 'https://www.qige.store/' }
  ],
  ...
  HEO_INFO_CARD_URL: 'https://www.qige.store/', // 个人资料底部按钮链接
  ...
  HEO_SOCIAL_CARD_URL: 'https://www.qige.store/',
